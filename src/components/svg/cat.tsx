...
import { TreeChristmasSvgPath, GiftsSvgPath, HatSantaSvgPath } from "./xmas";

export const enum CatDecoration {
  SantaHat,
  ChristmasTree,
}
...
const CatIcon: React.FC<CatIconProps> = ({
  ...
  let cat = <CatSvgPath gradient={gradient} />;
  let decor;
  if (decoration == CatDecoration.SantaHat) {
    cat = (
      <CatSvgPath
        gradient={gradient}
    ...
    decor = (
      <HatSantaSvgPath
        transform="scale(0.10) scale(-1,1) translate(-4100,1430) rotate(-5)"
...
export const CatSvgPath: React.FC<CatIconSvgProps> = ({
  gradient,
  ...props
}) => {
  ...
  return (
    <>
      <symbol viewBox="0 0 48.45 32.05" id={id}>
